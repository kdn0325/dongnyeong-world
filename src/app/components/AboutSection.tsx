      ...
      <div className="md:grid md:grid-cols-2 gap-8 items-center py-8 px-4 xl:gap-16 sm:py-16 xl:px-16">
        ...
        <div className="mt-4 md:mt-0 text-left flex flex-col h-full">
          ...
          <p className="text-base lg:text-lg">
            React와 React Native를 중심으로 웹 및 모바일 애플리케이션을 개발하는
            것을 즐기며, 코드 작성에 있어서는 꼼꼼함과 효율성을 추구합니다.
            새로운 기술에 대한 열정을 가지고 있으며, 항상 더 나은 솔루션을 찾기
            위해 노력합니다. 협업과 의사 소통 능력을 강화하여 팀에서 원활한
            업무를 수행하고 프로젝트를 성공적으로 완료하는 데 기여하고 있습니다.
            프론트엔드 개발 분야에서 지속적인 성장과 혁신을 추구하며,
            사용자들에게 최고의 디지털 경험을 제공하기 위해 노력하고 있습니다.
          </p>
